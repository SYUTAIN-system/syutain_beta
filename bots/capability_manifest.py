...
CAPABILITY_MANIFEST = {
    ...
    "chat_capabilities": [
        ...
        ("記事執筆依頼",    "「note で〜について書いて」"),
        ("情報収集",        "「最近のトレンド」「〜について調べて」"),
        ("Xリアルタイム調査", "「Xで〜を調べて」「Grok で AI エージェント動向 調査」— Grok Live Search で X/Web/News 横断、intel保存"),
    ...
    "slash_commands": [
        ...
        ("!依頼 <brief>",    "note 記事執筆依頼"),
        ("!xリサーチ <topic>", "Grok で X リアルタイムトレンド調査 (mode: balanced/tech/creator/business)"),
        ("!charlie",         "CHARLIE ノードのモード確認"),
        ("!レビュー",        "Brain-α レビュー手動トリガー"),
        ("!提案生成",        "3層提案エンジンを手動起動"),
        ("!予算設定 日次 月次", "予算変更 (例: !予算設定 150 2500)"),
        ("!収益記録 金額 プラットフォーム", "売上記録"),
    ],
    "proactive": [
        "エラー24h>0なら自動で言及",
        "承認待ち>0なら自動で伝える",
