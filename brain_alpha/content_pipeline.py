            ...
            try:
                ...
                result_title = await call_llm(
                    ...
                    system_prompt=(
                        ...
                        "## 効果の高いタイトルパターン (エンゲージメント実績)\n"
                        "- 具体数字で引く: AIに55,000行のコードを書かせて仕組みを作っている話\n"
                        "- 失敗を語る: AI開発で学んだ「失敗は恥じゃない。でも隠すのはどうかと」\n"
                        "- 知人の会話: 「島原、最近何やってんの？」\n"
                        "- コスト数字: 月1,041円で動くAI事業OSの現実\n"
                        "- 疑問形+具体: Claudeで非エンジニアが月3万円削減した...\n\n"
                        "## 避けるタイトルパターン\n"
                        "- SYUTAINβ日報 #XXXX で始まる日報タイトル (クリック率低い)\n"
                        "- 自由テーマ: intel_itemsで... 等の内部用語がむき出し\n"
                        "- 情景描写調 (夜のオフィスで...)\n"
                        "- 抽象的な AI 論 (AIの未来を考える)\n"
                    ),
