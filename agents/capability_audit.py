...
NODE_DEFINITIONS = {
    ...
    "bravo": {
        ...
        "gpu": "RTX_5070_12GB",
        "ollama_url": os.getenv("BRAVO_OLLAMA_URL", "http://100.75.146.9:11434"),
    ...
    "charlie": {
        ...
        "local_model": "qwen3.5-9b",
        "gpu": "RTX_3080_10GB",
        "ollama_url": os.getenv("CHARLIE_OLLAMA_URL", "http://100.70.161.106:11434"),
    ...
    "delta": {
        ...
        "gpu": "GTX_980Ti_6GB",
        "ollama_url": os.getenv("DELTA_OLLAMA_URL", "http://100.82.81.105:11434"),
        "services": ["nats_server"],
    },
}
