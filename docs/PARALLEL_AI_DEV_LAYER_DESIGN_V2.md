...
class NodeAwareness:
    NODES = {
        "bravo":   {"host": "100.75.146.9",   "ollama_model": "qwen3.5:9b"},
        "charlie": {"host": "100.70.161.106",  "ollama_model": "qwen3.5:9b"},
        "delta":   {"host": "100.82.81.105",   "ollama_model": "qwen3.5:4b"},
    }
...
15 23,0-6 * * * /Users/daichi/syutain_beta/venv/bin/python /Users/daichi/syutain_beta/pdl/pdl_orchestrator.py --mode=cron >> /Users/daichi/syutain_beta/logs/pdl_cron.log 2>&1

# Worktreeクリーンアップ: 毎日04:00 JST
0 4 * * * /Users/daichi/syutain_beta/venv/bin/python /Users/daichi/syutain_beta/pdl/cleanup_daemon.py >> /Users/daichi/syutain_beta/logs/pdl_cleanup.log 2>&1

# 中断復旧チェック: 毎時00分
0 * * * * /Users/daichi/syutain_beta/venv/bin/python /Users/daichi/syutain_beta/pdl/recovery_agent.py >> /Users/daichi/syutain_beta/logs/pdl_recovery.log 2>&1

# failure_memory重複排除: 毎時30分
30 * * * * /Users/daichi/syutain_beta/venv/bin/python /Users/daichi/syutain_beta/pdl/dedup_engine.py >> /Users/daichi/syutain_beta/logs/pdl_dedup.log 2>&1
EOF
) | crontab -
