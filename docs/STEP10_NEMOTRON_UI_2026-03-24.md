...
| ノード | モデル名 | サイズ | ステータス |
|--------|---------|--------|-----------|
| BRAVO (100.75.146.9) | nemotron-jp:latest | 7.1 GB | ✅ インストール済み |
| CHARLIE (100.70.161.106) | nemotron-jp:latest | 7.1 GB | ✅ インストール済み |
| DELTA | - | - | 対象外 (6GB VRAM) |
...
モデル: https://100.70.34.67:8443/models
設定: https://100.70.34.67:8443/settings
```
